...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		logger.info("Welcome home sweet home! The client locale is {}.", locale);
	...
	public String sendConsultation(@RequestParam("company") String company, @RequestParam("name") String name,
			@RequestParam("contact") String contact, @RequestParam("email") String email,
			@RequestParam("inquiry") String inquiry, RedirectAttributes rttr) {
		...
		try {
			...
			String content = "<html>" + "<body style='font-family: Arial, sans-serif; margin: 0; padding: 0;'>"
					...
					+ "    <td style='padding: 8px; border: 1px solid #005bac;'>" + company + "</td>" + "  </tr>"
					+ "  <tr>"
					+ "    <th style='text-align: left; padding: 8px; border: 1px solid #005bac; color: #005bac;'>이름</th>"
					+ "    <td style='padding: 8px; border: 1px solid #005bac;'>" + name + "</td>" + "  </tr>"
					+ "  <tr style='background-color: #f2f9ff;'>"
					+ "    <th style='text-align: left; padding: 8px; border: 1px solid #005bac; color: #005bac;'>연락처</th>"
					+ "    <td style='padding: 8px; border: 1px solid #005bac;'>" + contact + "</td>" + "  </tr>"
					+ "  <tr>"
					+ "    <th style='text-align: left; padding: 8px; border: 1px solid #005bac; color: #005bac;'>이메일</th>"
					+ "    <td style='padding: 8px; border: 1px solid #005bac;'>" + email + "</td>" + "  </tr>"
					+ "  <tr style='background-color: #f2f9ff;'>"
					+ "    <th style='text-align: left; padding: 8px; border: 1px solid #005bac; color: #005bac;'>문의 내용</th>"
					+ "    <td style='padding: 8px; border: 1px solid #005bac;'>" + inquiry + "</td>" + "  </tr>"
					+ "</table>" + "<p style='text-align: center; margin-top: 16px; color: #555;'>상담 신청해주셔서 감사합니다.</p>"
					+ "</div>" + "</body></html>";
