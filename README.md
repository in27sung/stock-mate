...
- **기능 추가:**
  1. 바코드/QR 스캔을 통한 재고 입출고 기능 구현
  2. 실시간 재고 조회 페이지 추가
  3. 재고 검색 필터 및 정렬 추가(상품명별 검색 가능)  
- **버그 수정:**  
  1. 스캔 데이터 누락 및 중복 문제 수정
  2. 재고 목록에서 일부 항목이 중복으로 표시되는 현상 수정
    
### [v1.0.1] - 2024-12-28
- **UI 개선:**
  1. 메인페이지 개선 (버튼 크기, 색상 조정 및 가독성 향상)
  2. 모바일 환경에서 레이아웃 깨짐 현상 수정
  3. 회사 로고 생성 및 추가
  4. 배경 이미지 변경 
...
### [v1.0.2] - 2025-01-12
- **성능 개선:**  
  1. 중복된 데이터 처리 로직 제거 및 코드 품질 향상
    
- **버그 수정:**  
  1. 재고 검색 시 일부 필터가 정상 작동하지 않는 문제 해결
  2. QR 스캔 시 특정 바코드가 인식되지 않는 문제 수정

### [v1.1.x] - 예정 (2025-01-15)
- **기능 추가 예정:**  
  - 재고 변동을 시각화하는 대시보드 기능 추가
  - 차트 및 그래프를 통한 재고 분석 기능 추가  

### [v1.2.x] - 예정 (2025-02-10)
- **기능 추가 예정:**  
